						...
						<div class="row">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="product_name" class="form-control @error('product_name') is-invalid @enderror" placeholder="Product">
									@error('product_name')
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									...
									<input id="product_price" type="text" name="product_price" class="form-control @error('product_price') is-invalid @enderror" placeholder="Rs, 2345">
									@error('product_price')
									<span class="invalid-feedback text-left" role="alert">{{ $message }}</span>
									@enderror
								</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									...
									<input id="product_quantity" type="number" name="product_quantity" class="form-control" placeholder="0">
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									<label>Total Amount <span class="required">*</span></label>
									<input id="total_amount" type="text" name="total_amount" class="form-control @error('total_amount') is-invalid @enderror" placeholder="Rs, 23432">
									@error('total_amount')
									<span class="invalid-feedback text-left" role="alert">{{ $message }}</span>
									@enderror
								</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									...
									<input id="amount_paid" type="text" name="amount_paid" class="form-control @error('amount_paid') is-invalid @enderror" placeholder="Rs, 10000">
									@error('amount_paid')
									<span class="invalid-feedback text-left" role="alert">{{ $message }}</span>
									@enderror
								</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									...
									<input id="amount_due" type="text" name="amount_due" class="form-control @error('amount_due') is-invalid @enderror" placeholder="Rs, 13432">
									@error('amount_due')
									<span class="invalid-feedback text-left" role="alert">{{ $message }}</span>
									@enderror
								</div>
